    ...
    <body>
        ...
        <?php
            ...
            while($row_usuario = mysqli_fetch_assoc($lista_usuarios)){
                ...
                echo "<a href='edit_usuario.php?id=" . $row_usuario['id'] . "'>Editar</a><br><hr><br>";
            }
            ...
            for($pagina_seguinte = $pagina + 1; $pagina_seguinte <=  $pagina + $max_links; $pagina_seguinte++){
                if($pagina_seguinte <= $qtd_pg) {
                    echo "<a href='listar.php?pagina=$pagina_seguinte'>$pagina_seguinte<a/> ";
                }
            }
            
            echo "<a href='listar.php?pagina=$qtd_pg'>Última<a/>";
        ?>
